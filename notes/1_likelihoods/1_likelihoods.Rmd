...
$$
f(y) =  \lim\limits_{h \rightarrow0^+} \frac{F(y + h) - F(y - h)}{2h} = \qquad \qquad \qquad \qquad \qquad
$$
...
Thus, exponential families often provide an automatic procedure for finding $\boldsymbol W$ and $\boldsymbol V$.
